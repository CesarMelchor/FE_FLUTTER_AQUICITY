...
class GalerryTwoPage extends StatefulWidget {
  const GalerryTwoPage({super.key});

  @override
  State<GalerryTwoPage> createState() => _GalerryTwoPageState();
}

class _GalerryTwoPageState extends State<GalerryTwoPage> {
  ...
  Future<bool> getGaleria() async {
    galeria = await dio.get('https://aqui.city/api/public/v1/galeria',
        queryParameters: {"id": idsend, "galeria": "2"});
