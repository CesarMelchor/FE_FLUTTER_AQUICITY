...
class GalerryOnePage extends StatefulWidget {
  const GalerryOnePage({super.key});

  @override
  State<GalerryOnePage> createState() => _GalerryOnePageState();
}

class _GalerryOnePageState extends State<GalerryOnePage> {
  ...
  Future<bool> getGaleria() async {
    galeria = await dio.get('https://aqui.city/api/public/v1/galeria',
        queryParameters: {"id": idsend, "galeria": "1"});
